...
namespace TrOCR.Helper
{
    public class OcrHelper
    {
        ...
        public static string SgBasicOpenOcr(Image image)
        {
            ...
            var sign = CommonHelper.Md5($"cf50840779b2b400c775d7fbadb02fa4basicOpenOcr{t}{imageData.Substring(0, Math.Min(1024, imageData.Length))}7afa7909b8205df61959aff73ad977bd");
            var data =
                $"lang=zh-Chs&pid=cf50840779b2b400c775d7fbadb02fa4&service=basicOpenOcr&sign={sign}&salt={t}&image={HttpUtility.UrlEncode(imageData)}";
            return CommonHelper.PostStrData(url, data);
        }
